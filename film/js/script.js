  ...
  * ============================================*/
    ...
    $('#gallery-all').click(function () {
        $('#btn-redirect').click(function() {
            window.location.href= './film/standalone-all.html'
        })
    })

    $('#gallery-concerts').click(function () {
        $('#btn-redirect').click(function() {
            window.location.href= './film/standalone-concerts.html'
        })
    })

    $('#gallery-festivals').click(function () {
        $('#btn-redirect').click(function() {
            window.location.href= './film/standalone-festivals.html'
        })
    })

    $('#gallery-sufi').click(function () {
        $('#btn-redirect').click(function() {
            window.location.href= './film/standalone-sufi.html'
        })
    })

    $('#gallery-movies').click(function () {
        $('#btn-redirect').click(function() {
            window.location.href= './film/standalone-movies.html'
        })
    })
